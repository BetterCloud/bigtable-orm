...
abstract class AbstractBigTableEntityDaoTest {
  ...
  static class TestColumns<T> implements Column {
    ...
    public static final TestColumns<String> STRING_VALUE =
        new TestColumns<>(
            "stringValueFamily", "stringValueQualifier", new TypeReference<String>() {}, false);
    public static final TestColumns<Boolean> BOOLEAN_VALUE =
        new TestColumns<>(
            "booleanValueFamily", "booleanValueQualifier", new TypeReference<Boolean>() {}, false);
    public static final TestColumns<TestNestedObject> NESTED_OBJECT =
        new TestColumns<>(
            "nestedObjectFamily",
            "nestedObjectQualifier",
  ...
  static class TestVersionedColumns<T> implements Column {
    ...
    public static final TestColumns<String> STRING_VALUE =
        new TestColumns<>(
            "stringValueFamily", "stringValueQualifier", new TypeReference<String>() {}, false);
    public static final TestColumns<Boolean> VERSIONED_BOOLEAN_VALUE =
        new TestColumns<>(
            "versionedBooleanValueFamily",
            "versionedBooleanValueQualifier",
  ...
  static class TestVersionedDelegate
      implements EntityConfiguration.EntityDelegate<TestVersionedEntity> {
