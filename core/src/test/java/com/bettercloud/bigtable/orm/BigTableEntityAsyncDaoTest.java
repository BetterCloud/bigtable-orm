...
public class BigTableEntityAsyncDaoTest extends AbstractBigTableEntityDaoTest {
  ...
  @Mock private AsyncTable<?> table;

  private final List<Column> columns =
      Lists.newArrayList(
          TestColumns.BOOLEAN_VALUE, TestColumns.STRING_VALUE, TestColumns.NESTED_OBJECT);

  private final Supplier<TestEntity> entityFactory = TestEntity::new;

  private final Function<TestEntity, EntityConfiguration.EntityDelegate<TestEntity>>
      delegateFactory = TestDelegate::new;

  private final List<Column> versionedColumns =
      Lists.newArrayList(
          TestVersionedColumns.STRING_VALUE, TestVersionedColumns.VERSIONED_BOOLEAN_VALUE);

  private final Supplier<TestVersionedEntity> versionedEntityFactory = TestVersionedEntity::new;

  private final Function<
          TestVersionedEntity, EntityConfiguration.EntityDelegate<TestVersionedEntity>>
      versionedDelegateFactory = TestVersionedDelegate::new;
  ...
  @Captor private ArgumentCaptor<List<Put>> putsArgumentCaptor;

  @Captor private ArgumentCaptor<Put> putArgumentCaptor;

  @Captor private ArgumentCaptor<List<Delete>> deletesArgumentCaptor;

  @Captor private ArgumentCaptor<Delete> deleteArgumentCaptor;

  @Captor private ArgumentCaptor<Scan> scanArgumentCaptor;
  ...
  public void setup() {
    ...
    testEntityDao =
        new BigTableEntityAsyncDao<>(table, columns, entityFactory, delegateFactory, objectMapper);
    testVersionedEntityDao =
        new BigTableEntityAsyncDao<>(
            table,
            versionedColumns,
            versionedEntityFactory,
            versionedDelegateFactory,
            objectMapper);
  }
  ...
  public void testGetIOExceptionsAreWrappedInExecutionException() throws Throwable {
    ...
    final byte[] stringValueBytes = new byte[] {1, 2, 3};

    when(stringValueCell.getValueArray()).thenReturn(stringValueBytes);

    when(result.getColumnLatestCell(
            Bytes.toBytes(TestColumns.STRING_VALUE.getFamily()),
            Bytes.toBytes(TestColumns.STRING_VALUE.getQualifier())))
        .thenReturn(stringValueCell);
  ...
  @Test
  public void testGetRetrievesAllColumns()
    ...
    when(result.getColumnLatestCell(
            Bytes.toBytes(TestColumns.BOOLEAN_VALUE.getFamily()),
            Bytes.toBytes(TestColumns.BOOLEAN_VALUE.getQualifier())))
        .thenReturn(booleanValueCell);

    when(objectMapper.readValue(
            booleanValueBytes, TestColumns.BOOLEAN_VALUE.getTestTypeReference()))
        .thenReturn(booleanValue);

    final Cell nestedObjectCell = mock(Cell.class);

    final byte[] nestedObjectBytes = new byte[] {5, 4, 3, 2, 1, 0};

    when(nestedObjectCell.getValueArray()).thenReturn(nestedObjectBytes);

    when(result.getColumnLatestCell(
            Bytes.toBytes(TestColumns.NESTED_OBJECT.getFamily()),
            Bytes.toBytes(TestColumns.NESTED_OBJECT.getQualifier())))
        .thenReturn(nestedObjectCell);

    when(objectMapper.readValue(
            nestedObjectBytes, TestColumns.NESTED_OBJECT.getTestTypeReference()))
  ...
  @Test
  public void testGetRetrievesNullValues()
      throws IOException, ExecutionException, InterruptedException {
    final String stringValue = "some string";
  ...
  @Test
  public void testGetRetrievesNonExistentCellsAsNullValues()
  ...
  @Test
  public void testGetRetrievesVersionedValuesAndTimestamps()
      throws IOException, ExecutionException, InterruptedException {
    final String stringValue = "some string";
    ...
    when(result.getColumnLatestCell(
            Bytes.toBytes(TestVersionedColumns.STRING_VALUE.getFamily()),
            Bytes.toBytes(TestVersionedColumns.STRING_VALUE.getQualifier())))
        .thenReturn(stringValueCell);

    when(objectMapper.readValue(
            stringValueBytes, TestVersionedColumns.STRING_VALUE.getTestTypeReference()))
        .thenReturn(stringValue);
    ...
    when(result.getColumnLatestCell(
            Bytes.toBytes(TestVersionedColumns.VERSIONED_BOOLEAN_VALUE.getFamily()),
            Bytes.toBytes(TestVersionedColumns.VERSIONED_BOOLEAN_VALUE.getQualifier())))
        .thenReturn(booleanValueCell);

    when(objectMapper.readValue(
            booleanValueBytes, TestVersionedColumns.VERSIONED_BOOLEAN_VALUE.getTestTypeReference()))
        .thenReturn(booleanValue);

    when(table.get(any(Get.class))).thenReturn(CompletableFuture.completedFuture(result));

    final CompletableFuture<TestVersionedEntity> retrievedEntity =
        testVersionedEntityDao.get(new StringKey<>("key"));
  ...
  @Test
  public void testGetRetrievesNonExistentVersionedCellsAsNullValuesAndNullTimestamps()
      throws ExecutionException, InterruptedException {
    final Result result = mock(Result.class);
    when(result.isEmpty()).thenReturn(false);
  ...
  @Test
  public void testGetWithLiveObjectMapper()
      throws IOException, ExecutionException, InterruptedException {
  ...
  @Test
  public void testGetRetrievesNullStringValueWithLiveObjectMapper()
      throws IOException, ExecutionException, InterruptedException {
    testEntityDao = new BigTableEntityAsyncDao<>(table, columns, entityFactory, delegateFactory);
  ...
  @Test
  public void testGetRetrievesNullBooleanValueWithLiveObjectMapper()
      throws IOException, ExecutionException, InterruptedException {
    testEntityDao = new BigTableEntityAsyncDao<>(table, columns, entityFactory, delegateFactory);
  ...
  @Test
  public void testGetRetrievesNullNestedObjectWithLiveObjectMapper()
      throws IOException, ExecutionException, InterruptedException {
    testEntityDao = new BigTableEntityAsyncDao<>(table, columns, entityFactory, delegateFactory);
  ...
  @Test
  public void testGetReturnsNullWhenResultIsEmpty()
      throws ExecutionException, InterruptedException {
    final Result result = mock(Result.class);
  ...
  public void testGetKeysIOExceptionWrappedInExecutionException() throws Throwable {
    ...
    when(table.get(anyList()))
        .thenReturn(Collections.singletonList(CompletableFuture.completedFuture(result)));

    final Key<TestEntity> key = new StringKey<>("key");
    final Set<Key<TestEntity>> keys = Collections.singleton(key);
    final Map<Key<TestEntity>, CompletableFuture<TestEntity>> retrievedEntities =
        testEntityDao.get(keys);
  ...
  @Test
  public void testGetKeysRetrievesAllColumns()
      throws IOException, ExecutionException, InterruptedException {
    final String stringValue = "some string";
  ...
  @Test
  public void testGetKeysRetrievesAllColumnsForMultipleKeys()
      throws IOException, ExecutionException, InterruptedException {
    ...
    final byte[] stringValueBytes1 = new byte[] {1, 2, 3};

    when(stringValueCell1.getValueArray()).thenReturn(stringValueBytes1);

    when(result1.getColumnLatestCell(
            Bytes.toBytes(TestColumns.STRING_VALUE.getFamily()),
            Bytes.toBytes(TestColumns.STRING_VALUE.getQualifier())))
        .thenReturn(stringValueCell1);
    ...
    final byte[] booleanValueBytes1 = new byte[] {0};
    ...
    when(result1.getColumnLatestCell(
            Bytes.toBytes(TestColumns.BOOLEAN_VALUE.getFamily()),
            Bytes.toBytes(TestColumns.BOOLEAN_VALUE.getQualifier())))
        .thenReturn(booleanValueCell1);

    when(objectMapper.readValue(
            booleanValueBytes1, TestColumns.BOOLEAN_VALUE.getTestTypeReference()))
        .thenReturn(booleanValue1);

    final Cell nestedObjectCell1 = mock(Cell.class);

    final byte[] nestedObjectBytes1 = new byte[] {5, 4, 3, 2, 1, 0};
    ...
    when(result1.getColumnLatestCell(
            Bytes.toBytes(TestColumns.NESTED_OBJECT.getFamily()),
            Bytes.toBytes(TestColumns.NESTED_OBJECT.getQualifier())))
        .thenReturn(nestedObjectCell1);

    when(objectMapper.readValue(
            nestedObjectBytes1, TestColumns.NESTED_OBJECT.getTestTypeReference()))
    ...
    final byte[] stringValueBytes2 = new byte[] {9, 8, 7};

    when(stringValueCell2.getValueArray()).thenReturn(stringValueBytes2);

    when(result2.getColumnLatestCell(
            Bytes.toBytes(TestColumns.STRING_VALUE.getFamily()),
            Bytes.toBytes(TestColumns.STRING_VALUE.getQualifier())))
        .thenReturn(stringValueCell2);
    ...
    final byte[] booleanValueBytes2 = new byte[] {9};
    ...
    when(result2.getColumnLatestCell(
            Bytes.toBytes(TestColumns.BOOLEAN_VALUE.getFamily()),
            Bytes.toBytes(TestColumns.BOOLEAN_VALUE.getQualifier())))
        .thenReturn(booleanValueCell2);

    when(objectMapper.readValue(
            booleanValueBytes2, TestColumns.BOOLEAN_VALUE.getTestTypeReference()))
        .thenReturn(booleanValue2);

    final Cell nestedObjectCell2 = mock(Cell.class);

    final byte[] nestedObjectBytes2 = new byte[] {3, 3, 3, 3, 3};
    ...
    when(result2.getColumnLatestCell(
            Bytes.toBytes(TestColumns.NESTED_OBJECT.getFamily()),
            Bytes.toBytes(TestColumns.NESTED_OBJECT.getQualifier())))
        .thenReturn(nestedObjectCell2);

    when(objectMapper.readValue(
            nestedObjectBytes2, TestColumns.NESTED_OBJECT.getTestTypeReference()))
        .thenReturn(nestedObject2);

    final Key<TestEntity> key1 = new StringKey<>("key1");
    final Key<TestEntity> key2 = new StringKey<>("key2");

    // The keys are passed in as a Set to remove duplicates, but converted to a List for use with
    // the HBase API.
    // The HBase API returns an array of Results, with indices corresponding to the List of keys.
    // Since the conversion from a Set to a List does not maintain order, we need to mock this
  ...
  @Test
  public void testGetKeysRetrievesNullValues()
      throws IOException, ExecutionException, InterruptedException {
    final String stringValue = "some string";
  ...
  @Test
  public void testGetKeysRetrievesNonExistentCellsAsNullValues()
      throws ExecutionException, InterruptedException {
    final Result result = mock(Result.class);
    when(result.isEmpty()).thenReturn(false);
  ...
  @Test
  public void testGetKeysRetrievesVersionedValuesAndTimestamps()
      throws IOException, ExecutionException, InterruptedException {
    final String stringValue = "some string";
    ...
    final Map<Key<TestVersionedEntity>, CompletableFuture<TestVersionedEntity>> retrievedEntities =
        testVersionedEntityDao.get(keys);
  ...
  @Test
  public void testGetKeysRetrievesNonExistentVersionedCellsAsNullValuesAndNullTimestamps()
      throws ExecutionException, InterruptedException {
    final Result result = mock(Result.class);
    when(result.isEmpty()).thenReturn(false);
  ...
  @Test
  public void testGetKeysWithLiveObjectMapper()
      throws IOException, ExecutionException, InterruptedException {
    testEntityDao = new BigTableEntityAsyncDao<>(table, columns, entityFactory, delegateFactory);
  ...
  @Test
  public void testGetKeysRetrievesNullStringValueWithLiveObjectMapper()
      throws IOException, ExecutionException, InterruptedException {
    testEntityDao = new BigTableEntityAsyncDao<>(table, columns, entityFactory, delegateFactory);
  ...
  @Test
  public void testGetKeysRetrievesNullBooleanValueWithLiveObjectMapper()
      throws IOException, ExecutionException, InterruptedException {
    testEntityDao = new BigTableEntityAsyncDao<>(table, columns, entityFactory, delegateFactory);
  ...
  @Test
  public void testGetKeysRetrievesNullNestedObjectWithLiveObjectMapper()
      throws IOException, ExecutionException, InterruptedException {
    testEntityDao = new BigTableEntityAsyncDao<>(table, columns, entityFactory, delegateFactory);
  ...
  @Test
  public void testGetKeysReturnsNullWhenRowDoesNotExist()
      throws ExecutionException, InterruptedException {
    final Result result = mock(Result.class);
    when(result.isEmpty()).thenReturn(true);
  ...
  public void testGetAllIOExceptionWrappedInExecutionException() throws Throwable {
    ...
    when(table.getAll(anyList()))
        .thenReturn(CompletableFuture.completedFuture(Collections.singletonList(result)));

    final Key<TestEntity> key = new StringKey<>("key");
    final Set<Key<TestEntity>> keys = Collections.singleton(key);
    final CompletableFuture<Map<Key<TestEntity>, TestEntity>> resultFuture =
        testEntityDao.getAll(keys);
  ...
  @Test
  public void testGetAllRetrievesAllColumns()
      throws IOException, ExecutionException, InterruptedException {
    final String stringValue = "some string";
  ...
  @Test
  public void testGetAllRetrievesAllColumnsForMultipleKeys()
      throws IOException, ExecutionException, InterruptedException {
    final String stringValue1 = "some string";
  ...
  @Test
  public void testGetAllRetrievesNullValues()
      throws IOException, ExecutionException, InterruptedException {
    final String stringValue = "some string";
  ...
  @Test
  public void testGetAllRetrievesNonExistentCellsAsNullValues()
      throws ExecutionException, InterruptedException {
    final Result result = mock(Result.class);
    when(result.isEmpty()).thenReturn(false);
  ...
  @Test
  public void testGetAllRetrievesVersionedValuesAndTimestamps()
      throws IOException, ExecutionException, InterruptedException {
    final String stringValue = "some string";
    ...
    final Key<TestVersionedEntity> key = new StringKey<>("key");
    final Set<Key<TestVersionedEntity>> keys = Collections.singleton(key);
    final CompletableFuture<Map<Key<TestVersionedEntity>, TestVersionedEntity>> resultFuture =
        testVersionedEntityDao.getAll(keys);
  ...
  @Test
  public void testGetAllRetrievesNonExistentVersionedCellsAsNullValuesAndNullTimestamps()
      throws ExecutionException, InterruptedException {
    final Result result = mock(Result.class);
    when(result.isEmpty()).thenReturn(false);
  ...
  @Test
  public void testGetAllWithLiveObjectMapper()
      throws IOException, ExecutionException, InterruptedException {
    testEntityDao = new BigTableEntityAsyncDao<>(table, columns, entityFactory, delegateFactory);
  ...
  @Test
  public void testGetAllRetrievesNullStringValueWithLiveObjectMapper()
      throws IOException, ExecutionException, InterruptedException {
    testEntityDao = new BigTableEntityAsyncDao<>(table, columns, entityFactory, delegateFactory);
  ...
  @Test
  public void testGetAllRetrievesNullBooleanValueWithLiveObjectMapper()
      throws IOException, ExecutionException, InterruptedException {
    testEntityDao = new BigTableEntityAsyncDao<>(table, columns, entityFactory, delegateFactory);
  ...
  @Test
  public void testGetAllRetrievesNullNestedObjectWithLiveObjectMapper()
      throws IOException, ExecutionException, InterruptedException {
    testEntityDao = new BigTableEntityAsyncDao<>(table, columns, entityFactory, delegateFactory);
  ...
  @Test
  public void testGetAllDoesNotContainKeyWhenRowDoesNotExist()
      throws ExecutionException, InterruptedException {
    final Result result = mock(Result.class);
    when(result.isEmpty()).thenReturn(true);
  ...
  public void testScanIOExceptionWrappedInExecutionException() throws Throwable {
    ...
    when(table.scanAll(any(Scan.class)))
        .thenReturn(CompletableFuture.completedFuture(Collections.singletonList(result)));
  ...
  @Test
  public void testScanRetrievesAllColumns()
      throws IOException, ExecutionException, InterruptedException {
    final Key<TestEntity> startKey = new StringKey<>("a"); // [97]
    final Key<TestEntity> endKey = new StringKey<>("z"); // [122]
    final String stringValue = "some string";
  ...
  @Test
  public void testScanRetrievesAllColumnsForMultipleRows()
      throws IOException, ExecutionException, InterruptedException {
    final String stringValue1 = "some string";
    final Key<TestEntity> startKey = new StringKey<>("a"); // [97]
    final Key<TestEntity> endKey = new StringKey<>("z"); // [122]
    ...
    final CompletableFuture<SortedMap<Key<TestEntity>, TestEntity>> resultFuture =
        testEntityDao.scan(startKey, true, endKey, true, 5);
  ...
  @Test
  public void testScanRetrievesNullValues()
      throws IOException, ExecutionException, InterruptedException {
    final String stringValue = "some string";
    final Key<TestEntity> startKey = new StringKey<>("a"); // [97]
    final Key<TestEntity> endKey = new StringKey<>("z"); // [122]
  ...
  @Test
  public void testScanRetrievesNonExistentCellsAsNullValues()
      throws IOException, ExecutionException, InterruptedException {
    final Key<TestEntity> startKey = new StringKey<>("a"); // [97]
    final Key<TestEntity> endKey = new StringKey<>("z"); // [122]
  ...
  @Test
  public void testScanRetrievesVersionedValuesAndTimestamps()
      throws IOException, ExecutionException, InterruptedException {
    final String stringValue = "some string";
  ...
  @Test
  public void testScanRetrievesNonExistentVersionedCellsAsNullValuesAndNullTimestamps()
      throws IOException, ExecutionException, InterruptedException {
    final Key<TestVersionedEntity> startKey = new StringKey<>("a"); // [97]
    final Key<TestVersionedEntity> endKey = new StringKey<>("z"); // [122]
  ...
  @Test
  public void testScanWithLiveObjectMapper()
      throws IOException, ExecutionException, InterruptedException {
    final Key<TestEntity> startKey = new StringKey<>("a"); // [97]
    final Key<TestEntity> endKey = new StringKey<>("z"); // [122]
    testEntityDao = new BigTableEntityAsyncDao<>(table, columns, entityFactory, delegateFactory);
  ...
  @Test
  public void testScanRetrievesNullStringValueWithLiveObjectMapper()
      throws IOException, ExecutionException, InterruptedException {
    final Key<TestEntity> startKey = new StringKey<>("a"); // [97]
    final Key<TestEntity> endKey = new StringKey<>("z"); // [122]
    testEntityDao = new BigTableEntityAsyncDao<>(table, columns, entityFactory, delegateFactory);
  ...
  @Test
  public void testScanRetrievesNullBooleanValueWithLiveObjectMapper()
      throws IOException, ExecutionException, InterruptedException {
    final Key<TestEntity> startKey = new StringKey<>("a"); // [97]
    final Key<TestEntity> endKey = new StringKey<>("z"); // [122]
    testEntityDao = new BigTableEntityAsyncDao<>(table, columns, entityFactory, delegateFactory);
  ...
  @Test
  public void testScanRetrievesNullNestedObjectWithLiveObjectMapper()
      throws IOException, ExecutionException, InterruptedException {
    final Key<TestEntity> startKey = new StringKey<>("a"); // [97]
    final Key<TestEntity> endKey = new StringKey<>("z"); // [122]
  ...
  public void testScanRowFiltersOnConstant() throws IOException {
    ...
    when(table.scanAll(scanArgumentCaptor.capture()))
        .thenReturn(CompletableFuture.completedFuture(Collections.singletonList(result)));
  ...
  @Test
  public void testSavePutsAllColumns()
      throws IOException, ExecutionException, InterruptedException {
    final String stringValue = "some string";
    ...
    final CompletableFuture<TestEntity> resultFuture =
  ...
  @Test
  public void testSavePutsAllColumnsWithLiveObjectMapper()
      throws IOException, ExecutionException, InterruptedException {
    testEntityDao = new BigTableEntityAsyncDao<>(table, columns, entityFactory, delegateFactory);
    ...
    assertTrue(
        put.has(
            Bytes.toBytes(TestColumns.NESTED_OBJECT.getFamily()),
            Bytes.toBytes(TestColumns.NESTED_OBJECT.getQualifier()),
            expectedNestedObjectBytes));
  }

  @Test
  public void testSavePutsNullStringValueWithLiveObjectMapper()
      throws IOException, ExecutionException, InterruptedException {
    testEntityDao = new BigTableEntityAsyncDao<>(table, columns, entityFactory, delegateFactory);
  ...
  @Test
  public void testSavePutsNullBooleanValueWithLiveObjectMapper()
      throws IOException, ExecutionException, InterruptedException {
    testEntityDao = new BigTableEntityAsyncDao<>(table, columns, entityFactory, delegateFactory);
  ...
  @Test
  public void testSaveWithPutsNullNestedObjectWithLiveObjectMapper()
      throws IOException, ExecutionException, InterruptedException {
    testEntityDao = new BigTableEntityAsyncDao<>(table, columns, entityFactory, delegateFactory);
  ...
  @Test
  public void testSavePutsNullValues()
      throws IOException, ExecutionException, InterruptedException {
    final String stringValue = "some string";
  ...
  @Test
  public void testSavePutsVersionedColumnsWithDefinedTimestamp()
      throws IOException, ExecutionException, InterruptedException {
    final String stringValue = "some string";
    ...
    final CompletableFuture<TestVersionedEntity> resultFuture =
        testVersionedEntityDao.save(new StringKey<>("key"), testVersionedEntity);
  ...
  @Test
  public void testSavePutsVersionedColumnsWithUndefinedTimestamp()
      throws IOException, ExecutionException, InterruptedException {
    final String stringValue = "some string";
  ...
  @Test
  public void testSaveEntitiesPutsAllColumns()
      throws IOException, ExecutionException, InterruptedException {
    final String stringValue = "some string";
    ...
    when(table.put(anyList()))
        .thenReturn(Collections.singletonList(CompletableFuture.runAsync(() -> {})));

    final Key<TestEntity> key = new StringKey<>("key");
    final Map<Key<TestEntity>, TestEntity> entities = Collections.singletonMap(key, testEntity);

    final Map<Key<TestEntity>, CompletableFuture<TestEntity>> savedEntities =
        testEntityDao.save(entities);
  ...
  @Test
  public void testSaveEntitiesPutsAllColumnsForMultipleEntities()
      throws IOException, ExecutionException, InterruptedException {
    final String stringValue1 = "some string";
  ...
  @Test
  public void testSaveEntitiesPutsAllColumnsWithLiveObjectMapper()
      throws IOException, ExecutionException, InterruptedException {
    testEntityDao = new BigTableEntityAsyncDao<>(table, columns, entityFactory, delegateFactory);
  ...
  @Test
  public void testSaveEntitiesPutsNullStringValueWithLiveObjectMapper()
      throws IOException, ExecutionException, InterruptedException {
    testEntityDao = new BigTableEntityAsyncDao<>(table, columns, entityFactory, delegateFactory);
  ...
  @Test
  public void testSaveEntitiesPutsNullBooleanValueWithLiveObjectMapper()
      throws IOException, ExecutionException, InterruptedException {
    testEntityDao = new BigTableEntityAsyncDao<>(table, columns, entityFactory, delegateFactory);
  ...
  @Test
  public void testSaveEntitiesWithPutsNullNestedObjectWithLiveObjectMapper()
      throws IOException, ExecutionException, InterruptedException {
    testEntityDao = new BigTableEntityAsyncDao<>(table, columns, entityFactory, delegateFactory);
  ...
  @Test
  public void testSaveEntitiesPutsNullValues()
      throws IOException, ExecutionException, InterruptedException {
    final String stringValue = "some string";
  ...
  @Test
  public void testSaveEntitiesPutsVersionedColumnsWithDefinedTimestamp()
      throws IOException, ExecutionException, InterruptedException {
    final String stringValue = "some string";
    ...
    final Key<TestVersionedEntity> key = new StringKey<>("key");
    final Map<Key<TestVersionedEntity>, TestVersionedEntity> entities =
        Collections.singletonMap(key, testVersionedEntity);

    final Map<Key<TestVersionedEntity>, CompletableFuture<TestVersionedEntity>> savedEntities =
        testVersionedEntityDao.save(entities);
  ...
  @Test
  public void testSaveEntitiesPutsVersionedColumnsWithUndefinedTimestamp()
      throws IOException, ExecutionException, InterruptedException {
    final String stringValue = "some string";
  ...
  @Test
  public void testSaveAllPutsAllColumns()
      throws IOException, ExecutionException, InterruptedException {
    final String stringValue = "some string";
    ...
    final CompletableFuture<Map<Key<TestEntity>, TestEntity>> entitiesFuture =
  ...
  @Test
  public void testSaveAllPutsAllColumnsForMultipleEntities()
      throws IOException, ExecutionException, InterruptedException {
    final String stringValue1 = "some string";
  ...
  @Test
  public void testSaveAllPutsAllColumnsWithLiveObjectMapper()
      throws IOException, ExecutionException, InterruptedException {
    testEntityDao = new BigTableEntityAsyncDao<>(table, columns, entityFactory, delegateFactory);
  ...
  @Test
  public void testSaveAllPutsNullStringValueWithLiveObjectMapper()
      throws IOException, ExecutionException, InterruptedException {
    testEntityDao = new BigTableEntityAsyncDao<>(table, columns, entityFactory, delegateFactory);
  ...
  @Test
  public void testSaveAllPutsNullBooleanValueWithLiveObjectMapper()
      throws IOException, ExecutionException, InterruptedException {
    testEntityDao = new BigTableEntityAsyncDao<>(table, columns, entityFactory, delegateFactory);
  ...
  @Test
  public void testSaveAllWithPutsNullNestedObjectWithLiveObjectMapper()
      throws IOException, ExecutionException, InterruptedException {
    testEntityDao = new BigTableEntityAsyncDao<>(table, columns, entityFactory, delegateFactory);
  ...
  @Test
  public void testSaveAllPutsNullValues()
      throws IOException, ExecutionException, InterruptedException {
    final String stringValue = "some string";
  ...
  @Test
  public void testSaveAllPutsVersionedColumnsWithDefinedTimestamp()
      throws IOException, ExecutionException, InterruptedException {
    final String stringValue = "some string";
    ...
    final CompletableFuture<Map<Key<TestVersionedEntity>, TestVersionedEntity>> entitiesFuture =
        testVersionedEntityDao.saveAll(entities);
  ...
  @Test
  public void testSaveAllPutsVersionedColumnsWithUndefinedTimestamp()
      throws IOException, ExecutionException, InterruptedException {
    final String stringValue = "some string";
