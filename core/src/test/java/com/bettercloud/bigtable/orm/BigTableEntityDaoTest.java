...
public class BigTableEntityDaoTest extends AbstractBigTableEntityDaoTest {
  ...
  @Mock private ResultScanner scanner;
  ...
  @Captor private ArgumentCaptor<List<Put>> putArgumentCaptor;

  @Captor private ArgumentCaptor<List<Delete>> deleteArgumentCaptor;
  ...
  public void setup() {
    ...
    testEntityDao =
        new BigTableEntityDao<>(table, columns, entityFactory, delegateFactory, objectMapper);
    testVersionedEntityDao =
        new BigTableEntityDao<>(
            table,
            versionedColumns,
  ...
  public void testGetRetrievesVersionedValuesAndTimestamps() throws IOException {
    ...
    final Optional<TestVersionedEntity> retrievedEntity =
  ...
  public void testGetAllRetrievesVersionedValuesAndTimestamps() throws IOException {
    ...
    final Map<Key<TestVersionedEntity>, TestVersionedEntity> retrievedEntities =
  ...
  public void testSavePutsVersionedColumnsWithDefinedTimestamp() throws IOException {
    ...
    final TestVersionedEntity result =
  ...
  public void testSaveAllPutsVersionedColumnsWithDefinedTimestamp() throws IOException {
    ...
    final Map<Key<TestVersionedEntity>, TestVersionedEntity> savedEntities =
