...
public class DaoFactory {
  ...
  @SuppressWarnings("WeakerAccess") // Public API
  public <T extends Entity> Dao<T> daoFor(final Class<T> entityType, final Options options)
      throws IOException {
    Objects.requireNonNull(entityType);

    final EntityConfiguration<T> entityConfiguration =
        EntityRegistry.getConfigurationForType(entityType);
  ...
  @SuppressWarnings("WeakerAccess") // Public API
  public <T extends Entity> Dao<T> daoFor(
      final EntityConfiguration<T> entityConfiguration, final Options options) throws IOException {
    ...
    final Function<T, EntityConfiguration.EntityDelegate<T>> delegateFactory =
        entityConfiguration::getDelegateForEntity;
