...
public class EntityAnnotationProcessorTest {
  ...
  public void testEntityProcessorSucceedsWithValidConfiguration() {
    ...
    final Compilation compilation =
        javac().withProcessors(new EntityAnnotationProcessor()).compile(javaFileObject);

    assertEquals(Compilation.Status.SUCCESS, compilation.status());

    final JavaFileObject generated =
        compilation
            .generatedSourceFile(PACKAGE_NAME + ".MyEntity")
  ...
  public void testEntityProcessorSucceedsWithValidArrayOnlyConfiguration() {
    final JavaFileObject javaFileObject =
        JavaFileObjects.forResource("ValidArrayOnlyConfiguration.java");
  ...
  public void testEntityProcessorSucceedsWithValidSingleArrayConfiguration() {
    final JavaFileObject javaFileObject =
        JavaFileObjects.forResource("ValidSingleArrayConfiguration.java");
