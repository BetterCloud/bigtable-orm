...
public class GeneratedObjectMethodsTest {
  ...
  public void testMultiObjectEntityToString() {
    ...
    assertEquals(
        "MultiObjectEntity{stringField='something else', booleanField=true}", a.toString());
  ...
  public void testSingleArrayEntityToString() {
    ...
    assertEquals(
        "SingleArrayEntity{stringArrayField=" + Arrays.toString(a.getStringArrayField()) + "}",
        a.toString());
  ...
  public void testMultiArrayEntityToString() {
    ...
    assertEquals(
        "MultiArrayEntity{stringArrayField="
            + Arrays.toString(a.getStringArrayField())
            + ", booleanArrayField="
            + Arrays.toString(a.getBooleanArrayField())
            + "}",
        a.toString());
  ...
  public void testObjectArrayComboEntityToString() {
    ...
    assertEquals(
        "ObjectArrayComboEntity{stringField='hello', booleanArrayField="
            + Arrays.toString(a.getBooleanArrayField())
            + "}",
        a.toString());
    ...
    assertEquals(
        "ObjectArrayComboEntity{stringField='world', booleanArrayField="
            + Arrays.toString(a.getBooleanArrayField())
            + "}",
        a.toString());
